...
namespace Agenda {
    ...
    public partial class dbAgendaDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string name, string telephone) {
...
namespace Agenda.dbAgendaDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([name] = @Original_na" +
                "me) AND ([telephone] = @Original_telephone))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([name], [telephone]) VALUES (@name, @telephone);\r\nSELE" +
                "CT Id, name, telephone FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [name] = @name, [telephone] = @telephone WHERE (([Id] = " +
                "@Original_Id) AND ([name] = @Original_name) AND ([telephone] = @Original_telepho" +
                "ne));\r\nSELECT Id, name, telephone FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Agenda.Properties.Settings.Default.dbAgendaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, telephone FROM dbo.[Table]";
        ...
        public virtual int Fill(dbAgendaDataSet.TableDataTable dataTable) {
        ...
        public virtual dbAgendaDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dbAgendaDataSet.TableDataTable dataTable = new dbAgendaDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dbAgendaDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_name, string Original_telephone) {
        ...
        public virtual int Insert(string name, string telephone) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string telephone, int Original_Id, string Original_name, string Original_telephone, int Id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string telephone, int Original_Id, string Original_name, string Original_telephone) {
            return this.Update(name, telephone, Original_Id, Original_name, Original_telephone, Original_Id);
        }
    }
